...
<!-- Mirrored from hencework.com/theme/hound/full-width-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 May 2021 10:23:30 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body>
    ...
    <div class="wrapper theme-4-active pimary-color-red">
		...
		<div class="page-wrapper">
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2021 &copy; Agbe Investment Farms.</p>
					</div>
				</div>
			</footer>
		</div>
    ...
    <script src="assets/backend//vendors/bower_components/jquery/dist/jquery.min.js"></script>
    <script src="assets/backend/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	<script src="assets/backend/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>	
	<script src="assets/backend/dist/js/jquery.slimscroll.js"></script>
	<script src="assets/backend/vendors/bower_components/moment/min/moment.min.js"></script>
	<script src="assets/backend/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
	<script src="assets/backend/dist/js/simpleweather-data.js"></script>
	<script src="assets/backend/vendors/bower_components/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="assets/backend/vendors/bower_components/jquery.counterup/jquery.counterup.min.js"></script>
	...
	<script src="assets/backend/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
	<script src="assets/backend/vendors/chart.js/Chart.min.js"></script>
    <script src="assets/backend/vendors/bower_components/raphael/raphael.min.js"></script>
    <script src="assets/backend/vendors/bower_components/morris.js/morris.min.js"></script>
    <script src="assets/backend/vendors/bower_components/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
	<script src="assets/backend/vendors/bower_components/switchery/dist/switchery.min.js"></script>
