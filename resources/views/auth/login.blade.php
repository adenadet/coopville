...
<html lang="en">
<head>
<title>DLC Ikeja Cooperative | Member Area Login</title>
<meta charset="utf-8">
    ...
    <div id="wrapper">
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle auth-main">
                <div class="auth-box">
                    <div class="top">
                        <img src="{{asset('assets/images/logo-dlcc.png')}}" alt="Ikeja Deanery Cooperative Logo">
                    </div>
                    <div class="card">
                        <div class="header">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="signin-email" class="control-label sr-only" name="lbl_email" id="lbl_email">Email/Username</label>
