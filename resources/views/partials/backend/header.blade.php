<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="index.html"><img src="https://dlcikejacoop.com.ng/assets/images/dlccikeja-logo.png" alt="Lucid Logo" class="img-responsive logo"></a>                
        </div>
        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">                        
                    ...
                    <li><a href="/logout" class="icon-menu" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="icon-login"></i></a>
